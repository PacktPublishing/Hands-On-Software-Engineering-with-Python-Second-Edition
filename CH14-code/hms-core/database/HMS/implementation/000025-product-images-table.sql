CREATE TABLE ProductImages (
    ...
    COMMENT 'The unique identifier of the Product that this record relates to/is owned by; a UUID value (for example b279fda6-eafc-40e5-b8c7-415ed864acf7).',
...
COMMENT='Tracks images related to Products in the system.'
;
