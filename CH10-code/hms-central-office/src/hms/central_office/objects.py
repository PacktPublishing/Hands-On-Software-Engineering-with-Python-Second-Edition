...
"""
    ...
    _data_dict_keys = (
        ...
        'company_name', 'website', 'oid', 'created',
        'modified', 'is_active', 'is_deleted', 'products'
    )
    ...
    def matches(self, **criteria) -> (bool,):
        return HMSMongoDataObject.matches(
            self, **criteria
        )
    ...
    def from_data_dict(cls, data_dict):
        # - This has to be overridden because we have to
        #   pre-process incoming address and (maybe,
        #   eventually?) product-list values...
